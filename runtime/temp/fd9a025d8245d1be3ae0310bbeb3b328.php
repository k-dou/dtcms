<?php /*a:2:{s:75:"D:\phpStudy\PHPTutorial\WWW\wolfbolg\application\admin\view\public_head.php";i:1571392445;s:80:"D:\phpStudy\PHPTutorial\WWW\wolfbolg\application\admin\view\background_index.php";i:1562260080;}*/ ?>
<div class="aright">
        ...
        <table width="100%">
            ...
            <?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                <tr>
                    ...
                    <td align="center"><img src='<?php echo htmlentities($vo['head_back_img']); ?>' width="150" /></td>
                    <td align="center"><img src='<?php echo htmlentities($vo['main_back_img']); ?>' width="150" /></td>
                    <td align="center"><?php echo htmlentities($vo['c_time']); ?></td>
                    <td align="center">
                        <a href="<?php echo url('background/edit',['id'=>$vo['id']]); ?>" class="layui-btn layui-btn-small">修改</a>
                    </td>
                </tr>
