<?php /*a:2:{s:75:"D:\phpStudy\PHPTutorial\WWW\wolfbolg\application\admin\view\public_head.php";i:1571392445;s:76:"D:\phpStudy\PHPTutorial\WWW\wolfbolg\application\admin\view\article_edit.php";i:1573025261;}*/ ?>
        ...
        <div class="dt-form-item">
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="text" name="title" required lay-verify="required" value="<?php if(!(empty($info) || (($info instanceof \think\Collection || $info instanceof \think\Paginator ) && $info->isEmpty()))): ?><?php echo htmlentities($info['title']); ?><?php endif; ?>" placeholder="必填内容" autocomplete="off" class="layui-input">
                </div>
            </div>
            <div class="layui-form-item" style="width: 300px;">
                ...
                <div class="layui-input-block" style="z-index:999;">
                    <select name="type" required lay-verify="required">
                        ...
                        <?php if(is_array($type) || $type instanceof \think\Collection || $type instanceof \think\Paginator): $i = 0; $__LIST__ = $type;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;if(empty($info) || (($info instanceof \think\Collection || $info instanceof \think\Paginator ) && $info->isEmpty())): ?>
            ...
            <div class="layui-form-item" style="width: 300px;">
                ...
                <div class="layui-input-block" >
                    <select name="status">
                        <option value="0">请选择</option>
                        <?php if(is_array($notes['status']) || $notes['status'] instanceof \think\Collection || $notes['status'] instanceof \think\Paginator): $i = 0; $__LIST__ = $notes['status'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;if(empty($info) || (($info instanceof \think\Collection || $info instanceof \think\Paginator ) && $info->isEmpty())): ?>
                                <option  value="<?php echo htmlentities($key); ?>"><?php echo htmlentities($vo); ?></option>
                                <?php else: ?>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <div class="file-box">
                    ...
                    <img src="<?php if(!(empty($info) || (($info instanceof \think\Collection || $info instanceof \think\Paginator ) && $info->isEmpty()))): ?><?php echo htmlentities((isset($info['img']) && ($info['img'] !== '')?$info['img']:'')); ?><?php endif; ?>" width="120">
...
<!--            TODO::添加标签-->
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <?php if(empty($info) || (($info instanceof \think\Collection || $info instanceof \think\Paginator ) && $info->isEmpty())): ?>
                    ...
                    <?php else: ?>
                    <input type="radio" name="is_md" value="1" title="markdown" class="is_md" <?php if($info['is_md'] == 1): ?>checked<?php else: ?>disabled<?php endif; ?>>
                    <input type="radio" name="is_md" value="2" title="富文本" class="is_md"   <?php if($info['is_md'] == 2): ?>checked<?php else: ?>disabled<?php endif; ?>>
                <?php endif; ?>
                ...
                <?php else: if($info['is_md'] == 2): ?>
                    ...
                    <div class="layui-input-block">
                        <div id="content-editormd" class="form-group" style='width:70%;height:550px;z-index:1010;margin:0'>
                            <textarea style="display:none;" class="form-control" id="content-editormd-markdown-doc" name="content-editormd-markdown-doc"><?php echo $info['content']; ?></textarea>
                        </div>
                    </div>
        ...
        <div class="layui-form-item">
            <div class="layui-input-block">
                <?php if(!(empty($info) || (($info instanceof \think\Collection || $info instanceof \think\Paginator ) && $info->isEmpty()))): ?><input type="hidden" name="id" value="<?php echo htmlentities($info['id']); ?>"><?php endif; ?>
